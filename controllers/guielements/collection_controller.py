...
class CollectionController:
    ...
    def add_collection(self,path:str,name:str):
        ...
        if(not changed_collection):
            ...
            msg.buttonClicked.connect(lambda button: (msg.standardButton(button)==QMessageBox.Yes) and self.image_provider.image_selector.change_collection(text=new_col.name))
